...
•	ALL Claims population: MPT_SENDPRO_ClaimType_ALL
•	MPT_SENDPRO_ValidClmEncProvider: SPRO_B_ENC_CLAIM_DNTL_LEG_HIST.BILLING_ENC_CLM_PRV_SEQ, SPRO_B_ENC_DNTL_INFO_DTL_HIST.BILLING_ENC_CLM_PRV_SEQ, 
SPRO_B_ENC_CLAIM_PHRM_LEG_HIST. BILLING_ENC_CLM_PRV_SEQ, SPRO_B_ENC_CLAIM_INST_LEG_HIST. BILLING_ENC_CLM_PRV_SEQ, 
SPRO_B_ENC_INST_INFO_DTL_HIST. BILLING_ENC_CLM_PRV_SEQ: 
...
SPRO_B_ENC_CLAIM_INST_LEG_HIST. BILLING_ENC_CLM_PRV_SEQ, 

*/

    CASE 
		 WHEN NOT EXISTS (SELECT tax.CDE_ENC_TAXONOMY from MHDWDEV.SENDPRO.spro_b_enc_provider_hist as prv
...
LEFT JOIN MHDWQA.SENDPRO.SPRO_B_ENC_PROVIDER_HIST prov_billing
    ON dntl.BILLING_ENC_CLM_PRV_SEQ = prov_billing.ENC_PRV_SEQ
