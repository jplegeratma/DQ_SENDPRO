DROP VIEW INF_SENDPRO_CLAIMS_DQ_7D_QA_UNPIV;

SELECT * FROM INF_SENDPRO_CLAIMS_DQ_7D_QA_UNPIV;

SELECT * 
FROM INF_SENDPRO_CLAIMS_DQ_7D_QA_UNPIV
...
FROM MHTEAM.DWDQ.INF_SENDPRO_CLAIMS_DQ_7D_QA_UNPIV
...
-- 8/8 moved to INF_SENDPRO_CLAIMS_DQ_7D_QA_UNPIV
-- thu 5/15 - first 7
-- wed 7/9 added benchmark

CREATE VIEW INF_SENDPRO_CLAIMS_DQ_7D_QA_UNPIV
AS
