...
*/
 -- DROP TABLE MHTEAM.DWDQ.INF_B_SENDPRO_TARGET_837M;

 -- CREATE TABLE MHTEAM.DWDQ.INF_B_SENDPRO_TARGET_837M AS
...
AND   prof.MD_BATCH_SEQ NOT IN ( SELECT DISTINCT tar.MD_BATCH_SEQ from MHTEAM.DWDQ.INF_B_SENDPRO_TARGET_837M tar)
 ) A;
