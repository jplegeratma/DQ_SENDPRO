...
/*
12.1.29	Record Status (MPT_SENDPRO_RecordStatus_NCPDP)
...
--    ON phrm.CLM_SEQ = pharm.CLM_SEQ
LEFT JOIN MHDWQA.SENDPRO.SPRO_B_ENC_PROVIDER_HIST prov_billing
    ON phrm.BILLING_ENC_CLM_PRV_SEQ = prov_billing.ENC_PRV_SEQ
--LEFT JOIN MHDWQA.SENDPRO.SPRO_B_ENC_PROVIDER_HIST prov_servicing
--    ON phrm.SERVICING_ENC_PRV_SEQ = prov_servicing.ENC_PRV_SEQ
--LEFT JOIN MHDWQA.SENDPRO.SPRO_B_ENC_PROVIDER_HIST prov_operating
--    ON phrm.OPERATING_ENC_CLM_PRV_SEQ = prov_operating.ENC_PRV_SEQ
