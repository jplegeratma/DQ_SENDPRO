...
SELECT * FROM INF_SENDPRO_CLAIMS_DQ_7M_QA_UNPIV;

SELECT * 
FROM INF_SENDPRO_CLAIMS_DQ_7M_QA_UNPIV
...
select count(1) from INF_SENDPRO_CLAIMS_DQ_7M_QA_UNPIV;
...
select * from INF_SENDPRO_CLAIMS_DQ_7M_QA_UNPIV limit 10;

DROP VIEW INF_SENDPRO_CLAIMS_DQ_7M_QA_UNPIV;

-- fri 8/8 - change to INF_SENDPRO_CLAIMS_DQ_7M_QA_UNPIV
-- thu 5/15 - first 7
-- wed 7/9 - added benchmark

CREATE VIEW INF_SENDPRO_CLAIMS_DQ_7M_QA_UNPIV
AS
