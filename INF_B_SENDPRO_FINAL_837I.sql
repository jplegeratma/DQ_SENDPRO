...
•	ALL Claims population: MPT_SENDPRO_ClaimType_ALL
•	MPT_SENDPRO_NumberIsNull_ALL: SPRO_B_ENC_CLAIM_PROF_LEG_HIST,QTY_BILLED,  SPRO_B_ENC_PROF_INFO_DTL_HIST.QTY_BILLED, SPRO_B_ENC_CLAIM_INST_LEG_HIST,QTY_BILLED,  SPRO_B_ENC_ INST_INFO_DTL_HIST.QTY_BILLED, SPRO_B_ENC_CLAIM_DNTL_LEG_HIST,QTY_BILLED,  SPRO_B_ENC_DNTL_INFO_DTL_HIST.QTY_BILLED, SPRO_B_ENC_CLAIM_PHRM_LEG_HIST, QTY_DISPD,  SPRO_B_ENC_PROF_INFO_DTL_HIST. QTY_PRESCRIBED
*/

    CASE 
        WHEN QTY_BILLED IS NULL THEN 'NULL'
        WHEN QTY_BILLED <= 0 THEN 'INVALID'
        ELSE 'VALID'
    END AS Quantity1X,
/*
